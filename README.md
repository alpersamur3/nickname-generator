...
Paket, şiirsel ve melankolik tonda Türkçe kelime listeleriyle gelir. Tüm kategoriler `opts.words` ile değiştirilebilir.

| Kategori | Anahtar | Örnek kelimeler |
|---|---|---|
| Sıfatlar | `adjectives` | `eski`, `sessiz`, `soluk`, `yalnız`, `donmuş` |
| İsimler | `nouns` | `tren`, `sis`, `mektup`, `ayna`, `şafak` |
| Renkler | `colors` | `sarı`, `mavi`, `gümüş`, `eflatun`, `kiremit` |
| Sayılar | `numbers` | `0`, `1`, `7`, `13`, `42` |
| Fiiller | `verbs` | `akan`, `yanan`, `sönen`, `kaybolan`, `sürüklenen` |
